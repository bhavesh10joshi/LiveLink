...
export function ConfirmDeleteGroup(props:DeleteGroupStyle)
{
    ...
    async function DeleteGroupHitBackend()
    {
        ...
        catch(e)
        {
            console.log(e);
            hideLoading();
            showError("Error encountered while deleting group!");
            return;
        }
    }
    return<>
        <div className="fixed inset-0 bg-black-500 bg-opacity-30 backdrop-blur-md flex justify-center items-center p-4">
            <div className=" bg-black-500 w-[95%] max-w-[30rem] rounded-xl flex flex-col">
                ...
                <div className="h-[3rem] w-full pt-[5rem] pr-[2rem] pl-[2rem] text-white flex justify-center items-center rounded-xl gap-2 pb-[3rem]">
