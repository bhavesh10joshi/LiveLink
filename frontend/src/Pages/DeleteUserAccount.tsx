    ...
    return<>
        <div className="fixed inset-0 bg-black-500 bg-opacity-30 backdrop-blur-md flex justify-center items-center">
                    <div className=" bg-black-500 w-[30rem] h-[30rem] rounded-xl flex flex-col">
                        ...
                        <div className="flex justify-center items-center mt-[1rem] pl-[2rem] pr-[2rem]"><div className="text-[1.3rem] font-bold text-slate-300">Delete Account?</div></div>
                        <div className="flex justify-center items-center text-center text-[0.8rem] text-slate-500 mt-[1rem]">{`Are You sure you want to delete this Account?`}</div>
