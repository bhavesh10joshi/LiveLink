...
export function EditUserProfile(props:EditStyle)
{
    ...
    function SetProfileImageFunction()
    {
    ...
    !ChangePassword
        ? !UploadprofileImage    
            ?<div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
                <div className=" bg-black-500 w-[30rem] h-[45rem] rounded-xl border-slate-300 border flex flex-col">
                    ...
                    <div className="flex justify-center items-center mt-[2rem] pl-[2rem] pr-[2rem]">
                        <button type="button" aria-label="Name" onClick={()=>SetProfileImageFunction()}><img src={props.ProfileImage} alt="" className="rounded-full w-[10rem]"/></button>
                    </div>
            ...
            :<UploadProfileImage SetProfileImageFunction={() => SetProfileImageFunction()} SetEditUserProfileFunction={()=>props.SetEditUserProfileSelector()}/>
        :<div>
