...
export function ChangePass()
{
    ...
    return<>
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-md flex-col p-4">
            ...
            <FingerPrint/>
            <div className="flex justify-center items-center text-white text-[1.5rem] lg:text-[2rem]">
                Change Password 
            </div>
            <div className="text-slate-500 text-[0.7rem] lg:text-[0.8rem]" >
                Update Your security settings to keep your account safe.
            </div>
            <div className="w-full flex justify-center items-center">
                <div className="pl-[2rem] pr-[2rem] flex justify-center items-center flex-col bg-slate-800 h-[20rem] w-[95%] max-w-[33rem] mt-[1rem] rounded-md">
