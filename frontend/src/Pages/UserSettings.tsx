...
export function UserSettings( props:Styles )
{
    ...
    const[BackendData , SetBackenddata]:any = useState(null);
        ...
        const HitBackend = async() =>
            {
                ...
                {       
                    setIsLoadingProfile(false);
                    showError("Error while fetching the User Info!");
                }
            }
        HitBackend();
    }, []);
                        ...
                        {isLoadingProfile || !BackendData
                            ...
                            : <>
                                ...
                                <div className=" pl-[2rem] pr-[2rem] relative flex-1 overflow-y-auto mb-4 mt-[1rem]">
                                    {BackendData.PersonalMessagingList.map((user:any)=>(<div className="bg-black-800 w-full h-[4rem] pt-[0.5rem] pb-[0.5rem] pl-[1rem] pr-[1rem] rounded-xl flex mt-[1rem] ">
                                        <div className="w-1/6">
