...
export function SideBar(props:SideBarStyles)
{
    ...
    <div className="lg:h-screen pt-[1rem] pb-[1rem] lg:pl-[1rem] w-full lg:w-auto h-auto fixed bottom-0 z-50 lg:static">
        <div className="bg-black-500 w-full lg:w-[16rem] h-[5rem] lg:h-full rounded-t-xl lg:rounded-md lg:pl-[2rem] lg:pr-[2rem] lg:pt-[1rem] lg:pb-[1rem] border-t lg:border border-slate-500 flex lg:flex-col flex-row justify-around lg:justify-start items-center overflow-x-auto px-2 lg:px-0">
            <div className="hidden lg:flex justify-start items-center">
                <div className="font-bold text-blue-800 text-[1.6rem]">
                    LiveLink
                </div>
            </div>
            <div className="flex justify-center items-center lg:mt-[2rem]">
            ...
            <div className="hidden lg:flex justify-center items-center mt-[1rem]">
                <div className="w-full flex justify-center items-center">
            ...
            {UserData != null
                ?<div className="hidden lg:flex mt-[2rem] justify-center items-center rounded-lg bg-slate-900 pt-[0.5rem] pb-[0.5rem] border border-blue-500">
